...
def get_sales_data():
    ...
    Run a while loop to collect the valid string of data from the user via the terminal,
    which must be a string of 6 numbers separated by commas.
    The loop will repeatadly request data until is valid.
    """
    while True:
...
def validate_data(values):
    ...
    or if there aren`t exactly six numbers.
...
def update_worksheet(data, worksheet):
    """
    Recives a list of integrs to be inserted into a worksheet.
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure substruct from the stock:
    -Psitive surplus indicate waste
...
def get_last_5_entries_sales():
    """
    Collects collumns of data from salesworksheet, 
